 ...
 * @author user
 */
public class JFrameLoginMitarbeiter extends javax.swing.JFrame {

    /**
     * Creates new form JFrameLoginMitarbeiter
     */
    public JFrameLoginMitarbeiter() {
        initComponents();
    ...
    public void erfolgAnmeldungMitarbeiter(String benutzername, int benutzerId) {
        MitarbeiterJFrame mt = new MitarbeiterJFrame();
        mt.setBenutzernameUndBenutzerIdLabel(benutzername, benutzerId);
        mt.setBenutzerId(benutzerId);
        mt.setVisible(true);
    ...
    //public void projektIdSpeicher(int projektleiterId){
    //}
    public void checkLoginMitarbeiter() {
        benuterName = jTextFieldBenutzerName.getText();
        passwort = String.valueOf(jPasswordField1.getPassword());
        int benutzerId = MitarbeiterHandler.checkLoginMitarbeiter(benuterName, passwort);

        if (benutzerId != -1) {
            erfolgAnmeldungMitarbeiter(benuterName, benutzerId);
        } else {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldBenutzerName, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameLoginMitarbeiter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameLoginMitarbeiter().setVisible(true);
            }
        });
    }
